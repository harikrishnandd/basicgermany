...
export default function SocialShare({ title, url }) {
  ...
  // WhatsApp share - crucial for Indian expat demographic
  ...
  return (
    <div className="social-share">
      <div className="social-share-buttons">
        {/* WhatsApp - Primary for Indian expat community */}
        <button 
      ...
      <style jsx>{`
        ...
        .social-share-button {
          ...
          border-radius: 8px;
          background: var(--systemBackground, #fff);
        ...
        @media (max-width: 640px) {
          .social-share-button span:not(.material-symbols-outlined) {
            display: none;
          }
        ...
        @media (prefers-color-scheme: dark) {
          .social-share-button {
            ...
            color: var(--systemPrimary, #fff);
            border-color: var(--systemBorder, #38383a);
          }

          .social-share-button:hover {
            background: var(--systemTertiaryBackground, #2c2c2e);
          }
        }
      `}</style>
    </div>
