...
// Debug helper - logs password configuration status (NOT the actual password)
if (typeof window !== 'undefined') {
  console.log('[Auth Debug] Password configured:', !!process.env.NEXT_PUBLIC_ADMIN_PASSWORD);
  console.log('[Auth Debug] Password length:', process.env.NEXT_PUBLIC_ADMIN_PASSWORD?.length || 0);
  console.log('[Auth Debug] Using default fallback:', !process.env.NEXT_PUBLIC_ADMIN_PASSWORD);
